...
contrato(508481287,508592909, 'Aquisicao de bens moveis', 'Consulta Previa', 'Aquisicao de seringas', 5653.40, '352 dias', '14-01-2020').
...
contrato(unknownidAd, 505044897, 'Aquisicao de bens moveis', 'Ajuste Direto', 'Aquisicao de materiais para a manutencao das infraestruturas da AdDP', 267.50, '3 dias', '02-04-2020').
...
contrato(600014690, unknownidAda, 'Aquisicao de servicos', 'Ajuste Direto', 'Prestacao de assistencia tecnica para o software de gestao da bilioteca para a SGPCM', 2250, '365 dias', '30-03-2020').
...
excecao(contrato(506346773, 503504564, 'Locacao de bens moveis', 'Contrato Publico', 'Fornecimento de energia eletrica para as instalacoes da GESAMB', 1780.22, '365 dias', 'Evora', '18-01-2020')). 
excecao(contrato(506346773, 980245974, 'Locacao de bens moveis', 'Contrato Publico', 'Fornecimento de energia eletrica para as instalacoes da GESAMB', 1780.22, '365 dias', 'Evora', '18-01-2020')).
...
adjudicante(7, 'Autoridade Tributaria e Aduaneira', 600084779, 'Lisboa').
adjudicante(8, 'Supremo Tribunal Administrativo', 600006638, 'Lisboa').
adjudicante(9, 'Centro Hospitalar Universitario de Lisboa Norte', 508481287, 'Lisboa').
adjudicante(10,'Gestao Ambiental e de Residuos', 506346773, 'Evora').

adjudicante(11, 'Secretaria-Geral da Presidencia do Conselho de Ministros',600014690).

% ------- Conhecimento Perfeito Negativo
-adjudicante(13, 'Municipio de Braganca', 501128840, 'Braganca').

% ------- Conhecimento Imperfeito Incerto
adjudicante(12, 'aguas do Douro e Paiva', unknown_nif, 'Vila Nova de Gaia').
...
adjudicataria(3, 'Plateia de Calculos Unipessoal Lda', 515204463, 'Braga').
...
adjudicataria(10, 'Endesa Energia', 980245974, 'Portugal').
...
% ------- Conhecimento Imperfeito Incerto
adjudicataria(12, 'BIBLIOSOFT Informatica, Formacao e Servicos Lda', unknown_nif, 'Portugal').
