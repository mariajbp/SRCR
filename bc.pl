...
contrato(600018709,502381973, 'Aquisição de serviços', 'Ajuste Direto', 'Aquisição de serviços de acesso à DATAJURIS – Base de Dados Jurídicos', 4000, '1095 dias','Lisboa', '19-03-2020').
...
contrato(506346773, 503504564, 'Locação de bens móveis', 'Contrato Público', 'Fornecimento de energia elétrica para as instalações da GESAMB', 1780.22, '365 dias','Évora' '18-01-2020'). 
contrato(506346773, 980245974, 'Locação de bens móveis', 'Contrato Público', 'Fornecimento de energia elétrica para as instalações da GESAMB', 1780.22, '365 dias','Évora' '18-01-2020'). 
...
% ------- Conhecimento Imperfeito Incerto
adjudicante(11, 'Águas do Douro e Paiva, S. A.', unknown_nif, 'Vila Nova de Gaia').
